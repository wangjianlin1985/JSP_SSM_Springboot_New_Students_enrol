    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=1">学校食品</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=2">教师介绍</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=3">学校办公室</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=4">校园资讯</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=5">学校活动</a></li>
                <li><a href="<%=basePath %>map.jsp">学校地图</a></li>  
